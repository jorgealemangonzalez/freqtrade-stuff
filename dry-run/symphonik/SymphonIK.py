...
class SymphonIK(IStrategy):
    ...
    def slow_tf_indicators(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
       ...
       # Pares en 3m
        ...
        dataframe3m['hma800'] = tv_hma(dataframe3m, 800)
        ...
        dataframe5m['hma444'] = tv_hma(dataframe5m, 444)
        dataframe5m['hma800'] = tv_hma(dataframe5m, 800)
        ...
        dataframe10m['hma888'] = tv_hma(dataframe10m, 888)
